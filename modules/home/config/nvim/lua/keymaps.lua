...
map("n", "<Space>dr", ":wall | !/home/fonil/minecraftmoding/energizemod/deployandrun.sh<CR>", { desc = "Save and Execute Deploy Script and Run" })
map("n", "<Space>de", ":wall | !/home/fonil/minecraftmoding/energizemod/deploy.sh<CR>", { desc = "Save & Execute Deploy Script" })
